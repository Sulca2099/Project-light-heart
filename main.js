...
class test{
    ...
    test_intergrate(){
        //alert('loaded');
        if(this.cnt<5){
            document.getElementById('workwithme').innerHTML=this.questions[this.cnt]+'<br>';
            let f=0;
    ...
    answer(count){
        if(this.cnt<5){
            ...
            document.getElementById('workwithme').innerHTML=["tomato and tofu","eggs and bacon","tropial food"][this.user_score.indexOf(favorite)];
        }
    }
}
let urtest=new test();
